...
export const WOW_GET_RAIDS_URL = WOW_BASE_URL + 'fetch_raids/';
export const WOW_DELETE_RAID_URL = WOW_BASE_URL + 'delete_raid_record/';
export const WOW_EDIT_RAID_URL = WOW_BASE_URL + 'edit_raid/';
